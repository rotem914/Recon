...
| The timeline's ground | `--editor-check`, S2.8: the strip's background equal to the page's own, a 0 px top line, the first thumbnail 16 px under the tabs' bottom edge; the default 132 tall with 112 px thumbnails ending at 120, the second row entering at 432. A taller strip still covers the sidebar's buttons and the size. A look at the real timeline is Rotem's hand. |
